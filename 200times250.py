...
docPath = "C:\\Users\\Li Chung Ho\\Downloads\\Progress photo report\\ZHEC Progress photo report May- 200x250 (Sample).docx"
imgPath = "C:\\Users\\Li Chung Ho\\Downloads\\May 2023\\5-25.jpg"
imgDirPath = "C:\\Users\\Li Chung Ho\\Downloads\\May 2023"
outputPath = "C:\\Users\\Li Chung Ho\\Downloads\\Output2.docx"
...
for i in range(36):
    ...
    p.add_run().add_picture(imgDirPath + "\\" + imgPathList[i], height=Inches(8.27))
    p.alignment = 1
